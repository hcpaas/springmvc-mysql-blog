...
RUN cd /root && \
    curl -o apache-tomcat.tar.gz http://mirrors.tuna.tsinghua.edu.cn/apache/tomcat/tomcat-8/v$TOMCAT_VERSION/bin/apache-tomcat-$TOMCAT_VERSION.tar.gz && \
    tar -zxvf apache-tomcat.tar.gz && \
    mv /root/apache-tomcat-$TOMCAT_VERSION/* /usr/local/tomcat/ && \
